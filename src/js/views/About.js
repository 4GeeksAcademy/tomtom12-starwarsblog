...
const About = () => {
    ...
    if (params.type === 'people') {
        ...
        console.log("this is the type",params.type)
        fields = (
            <div className='fixed-about'>
                <div className='top'>
                    <img
                        src={`https://starwars-visualguide.com/assets/img/planets/${parseInt(params.id) + 1}.jpg`}
                        onError={(e) => {
                            e.target.src = 'https://starwars-visualguide.com/assets/img/placeholder.jpg';
                        }}
                    />
        ...
        fields = (
            <div className='fixed-about'>
                <div className='top'>
                    <img
                        src={`https://starwars-visualguide.com/assets/img/vehicles/${parseInt(params.id) + 1}.jpg`}
                        onError={(e) => {
                            e.target.src = 'https://starwars-visualguide.com/assets/img/placeholder.jpg';
                        }}
                    />
